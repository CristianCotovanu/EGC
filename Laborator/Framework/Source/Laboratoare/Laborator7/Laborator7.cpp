...
void Laborator7::Init()
{
	...
	// Create a shader program for drawing sphere with the color of the normal
	{
...
{
	{
		...
		RenderSimpleMesh(meshes["sphere"], shaders["ShaderLab7"], modelMatrix, glm::vec3(0, 0, 0.7f));
	}

	{
		...
		RenderSimpleMesh(meshes["box"], shaders["ShaderLab7"], modelMatrix, glm::vec3(0.7f, 0, 0));
	}
